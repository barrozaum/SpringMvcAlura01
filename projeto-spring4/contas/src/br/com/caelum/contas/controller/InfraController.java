...
//		PreparedStatement st1 = c.prepareStatement("drop table contas ");
//		st1.execute();

		PreparedStatement st11 = c.prepareStatement("create table contas (id int identity, descricao varchar(255), valor double, paga boolean, dataPagamento date, tipo varchar(20))");
		st11.execute();
